...
export const partners = [
  ...
  },
  {
    ...
    overview: {
      title: "Company Overview",
      description:
        "Myanmar, also known as the Republic of the Union of Myanmar or Burma, is currently ranked as the 26th most populated country in the world with more than 54 million people residing in the country. With a land area of 653,508-kilometre square, Myanmar is also considered the biggest of the Mainland Southeast Asian states in terms of area. Out of the total population, around 89 percent of them are Buddhists. The capital city of Myanmar is Nay Pyi Taw while the largest city in the country is Yangon.",
    },
    popular_route: {
      title: "Popular Routes",
      route: [
